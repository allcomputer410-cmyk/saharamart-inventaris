@echo off
title Build SyncAgent.exe - ARAFAMART
color 0A
cd /d "%~dp0"

echo.
echo  ============================================================
echo    BUILD SYNC AGENT - ARAFAMART (ARM01)
...
if not exist "dist\SyncAgent-ARAFAMART" mkdir "dist\SyncAgent-ARAFAMART"
copy "dist\SyncAgent.exe" "dist\SyncAgent-ARAFAMART\SyncAgent.exe" >nul
copy ".env"               "dist\SyncAgent-ARAFAMART\.env"           >nul
...
) > "dist\SyncAgent-ARAFAMART\CARA PAKAI.txt"

echo.
echo  ============================================================
echo   BUILD BERHASIL!
echo.
echo   Hasil ada di: dist\SyncAgent-ARAFAMART\
...
explorer "dist\SyncAgent-ARAFAMART"
pause
